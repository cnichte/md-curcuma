import {
  ...
  /**
   ** Transformiert Obsidian nach Obsidian
   ** TAGEBUCH: /Users/cnichte/Datenbanken/obsidian-vaults/carsten-nichte-projekte/Tagebuch/Einträge-Archiv
   *
   *  - Einfügen von Frontmatter (vorhandenes ersetzen)
   *  - Frontmatter: title aus Dateiname.
   *  - Frontmatter: created aus Datei
   *  - Frontmatter: updated aus Datei
   * 
  ...
  const md_transporter_parameter: MD_Transporter_Parameter_Type = {
    readPath: "/Users/cnichte/Datenbanken/obsidian-vaults/carsten-nichte-projekte/Tagebuch/Einträge-Archiv",
    writePath: "test-data-obidian/obsidian-vault-1/",
    doSubfolders: true,
    limit: 1990,
    useCounter: false,
