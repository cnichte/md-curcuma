...
import { MD_Transporter, MD_Transporter_Parameter_Type } from "../src/lib/transporter/md-transporter";
...
const transporter_parameter: MD_Transporter_Parameter_Type = {
  ...
  writePath: "test-data_hugo/hugo-content-2/",
  doSubfolders: false,
  limit: 1990,
  useCounter: false,
  simulate: false
...
const parameter_images: MD_Transformer_Parameter_Type = {
  ...
  copy_task: {
    source:"test-data_obsidian-vault/images/",
    target:"test-data_hugo/hugo-content-2/assets/images/{name}/",
...
const parameter_docs: MD_Transformer_Parameter_Type = {
  ...
  copy_task: {
    ...
    target:"test-data_hugo/hugo-content-2/static/downloads/",
    simulate:simulate_copy_job
  }
};
