...
// TODO: Url umbauen. Für den MacFamilyTree Wrangler.

export interface Url_IO_Props_Interface {
...
export class Url_IO<D> implements IO_Observable_Reader_Interface<D>, Observable<D> {
  ...
  private props: Url_IO_Props_Interface = null;

  constructor(props: Url_IO_Props_Interface) {
    this.props = props;
  }
