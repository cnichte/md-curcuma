export interface Mapping_Properties {
  source: any;
  target: any;
...
// TODO Das alles ist irgendwie doppelt da?

export interface Mapping_Task {
  // perform(source_value: any, target_value: any): any;
  perform(mapping_properties: Mapping_Properties): any;
}
